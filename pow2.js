...
const pow2 = (function() {
	...
	let _aTiles = [ //2D array of <div> tiles;  null = empty tile
		[null, null, null, null],
		[null, null, null, null],
		[null, null, null, null],
		[null, null, null, null]
	...
	let _elemTilt = null; //show tilt animation
...
function UpdateScores() {
	...
	fetch('/content/pow2/index.php', opt).then(resp => resp.json()).then(aScores => {
		...
		//update high scores
		const tbl = document.querySelector('#pow2Scores');
...
function Reset() {
	...
	_score = 0;
	_gameID = '';
	_elemTilt = document.getElementById('pow2Tilt');
